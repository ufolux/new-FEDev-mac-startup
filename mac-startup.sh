...
colorTitle "step 6.install cocoapods"
colorSubTitle " - install ruby"
brew install ruby
colorSubTitle " - install cocoapods"
sudo gem install cocoapods

colorTitle "step 7.install maven"
brew install maven

colorTitle "step 8.install gradle"
brew install gradle

colorTitle "step 9.install android-sdk"
brew cask install android-sdk

colorTitle "step 10.export android env path"
...
colorTitle "step 11.install cordova"
npm i -g cordova@5.0.0

colorTitle "step 12.install react-native-cli"
npm i -g react-native-cli

colorTitle "step 13.install other tools"
...
colorTitle "step 14.install java"
